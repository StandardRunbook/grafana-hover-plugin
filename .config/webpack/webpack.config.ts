    ...
    plugins: [
      new CopyWebpackPlugin({
        patterns: [
          ...
          { from: "bin/grafana-plugin-api-darwin_amd64", to: "gpx_hover-hover-panel_darwin_amd64", toType: "file", noErrorOnMissing: true },
          { from: "bin/grafana-plugin-api-darwin_arm64", to: "gpx_hover-hover-panel_darwin_arm64", toType: "file", noErrorOnMissing: true },
          { from: "bin/grafana-plugin-api-linux_amd64", to: "gpx_hover-hover-panel_linux_amd64", toType: "file", noErrorOnMissing: true },
          { from: "bin/grafana-plugin-api-linux_arm64", to: "gpx_hover-hover-panel_linux_arm64", toType: "file", noErrorOnMissing: true },
          { from: "bin/grafana-plugin-api-windows_amd64.exe", to: "gpx_hover-hover-panel_windows_amd64.exe", toType: "file", noErrorOnMissing: true },
        ],
      }),
